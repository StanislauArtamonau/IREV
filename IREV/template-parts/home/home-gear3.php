...
<section class="home_gear3">
    ...
    <div class="home_gear3_container">
        ...
        <div class="home_gear3_reviews_container">

            <div class="home_gear3_reviews" data-client="client1">
                ...
                <div class="home_gear3_reviews_review selected">
...
a game-changer for us. You wouldn't find the same convenience elsewhere.</span>
            ...
            <div class="home_gear3_reviews" data-client="client2">
                <div class="home_gear3_reviews_review">
                    <span>text 1</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
...
a game-changer for us. You wouldn't find the same convenience elsewhere.</span>
            ...
            <div class="home_gear3_reviews" data-client="client3">
                <div class="home_gear3_reviews_review">
                    <span>text 1</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
...
a game-changer for us. You wouldn't find the same convenience elsewhere.</span>
            ...
            <div class="home_gear3_reviews selected" data-client="client4">
                <div class="home_gear3_reviews_review">
                <span>text 1</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
                        <div class="client_info">
                            <span class="client_name">Daniel Gram</span>
                            <span class="client_additional">bulls media</span>
                        </div>
                    </div>
                </div>
...
a game-changer for us. You wouldn't find the same convenience elsewhere.</span>
            ...
            <div class="home_gear3_reviews" data-client="client5">
                <div class="home_gear3_reviews_review">
                    <span>text 1</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
...
a game-changer for us. You wouldn't find the same convenience elsewhere.</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
                        <div class="client_info">
                            <span class="client_name">DChloe Bennett</span>
                            <span class="client_additional">bulls media</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="home_gear3_reviews" data-client="client6">
                <div class="home_gear3_reviews_review">
                    <span>text 1</span>
                    <div class="client">
                        <img src="<?php echo esc_url(get_theme_file_uri('src/icons/avatar4.svg')); ?>"/>
