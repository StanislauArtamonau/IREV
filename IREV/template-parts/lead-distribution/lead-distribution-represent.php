<?php
/**
 * Template Part: Lead Distribution Represent
 */
?>
...
<section class="lead_distribution_represent">
    ...
    <div class="represent_label">
        ...
        <span>Precision Routing. Maximum Performance</span>
    </div>
    ...
    <span class="represent_text_lower">Smart lead routing and real-time traffic control to maximize revenue from every click.</span>
</section>